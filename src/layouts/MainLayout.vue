            ...
            <q-menu auto-close>
              <q-list dense>
                <q-item class="GL__menu-link-signed-in">
                  <q-item-section>
                    <div>
                      <strong>{{activeUserInfo.displayName}}</strong>
                    </div>
                  </q-item-section>
                </q-item>
                <q-separator />
    ...
    <q-page-container class="GPL__page-container">
      ...
      <q-page-sticky v-if="$q.screen.gt.sm" expand position="left">
        <div class="fit q-pt-md q-px-sm column">
          <q-btn to="/course" round flat color="grey-8" stack no-caps size="26px" class="GPL__side-btn">
            <q-icon size="22px" name="book" />
            <div class="GPL__side-btn__label">Course</div>
          </q-btn>
        </div>
      </q-page-sticky>
    </q-page-container>
...
export default {
  ...
  data() {
    return {
      ...
      storage: 0.26,
      navigations: [
        { icon: "category", text: "Grade", to: "/grade" },
        { icon: "grade", text: "Grade Detail", to: "/grade-detail" },
        { icon: "book", text: "Course", to: "/course" },
        { icon: "people", text: "User Management", to: "/user-management" },
